"use strict";var yt=Object.create;var G=Object.defineProperty;var vt=Object.getOwnPropertyDescriptor;var Ut=Object.getOwnPropertyNames;var xt=Object.getPrototypeOf,wt=Object.prototype.hasOwnProperty;var kt=(r,e)=>{for(var t in e)G(r,t,{get:e[t],enumerable:!0})},Oe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ut(e))!wt.call(r,n)&&n!==t&&G(r,n,{get:()=>e[n],enumerable:!(s=vt(e,n))||s.enumerable});return r};var x=(r,e,t)=>(t=r!=null?yt(xt(r)):{},Oe(e||!r||!r.__esModule?G(t,"default",{value:r,enumerable:!0}):t,r)),Ft=r=>Oe(G({},"__esModule",{value:!0}),r);var ls={};kt(ls,{generateContext:()=>fe});module.exports=Ft(ls);var It=x(require("path"),1),Lt=require("os"),Mt=require("fs");var oe=require("bun:sqlite");var T=require("path"),te=require("os"),y=require("fs");var Ae=require("url");var L=require("fs"),Re=require("path");var Z=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Z||{}),ee=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=D.logsDir();(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Re.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=D.settings();if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Z[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let g="";if(n){let{sessionId:E,memorySessionId:S,correlationId:b,...p}=n;Object.keys(p).length>0&&(g=` {${Object.entries(p).map(([h,f])=>`${h}=${f}`).join(", ")}}`)}let l=`[${i}] [${a}] [${d}] ${m}${s}${g}${u}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,l+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=m?`${m[1].split("/").pop()}:${m[2]}`:"unknown",g={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,g,n),o}},c=new ee;var Yt={};function $t(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Ae.fileURLToPath)(Yt.url))}var Pt=$t();function Ht(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,T.join)((0,te.homedir)(),".claude-mem"),e=(0,T.join)(r,"settings.json");try{if((0,y.existsSync)(e)){let t=JSON.parse((0,y.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var O=Ht(),v=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,te.homedir)(),".claude"),fs=(0,T.join)(v,"plugins","marketplaces","thedotmack"),Gt=(0,T.join)(O,"archives"),jt=(0,T.join)(O,"logs"),Xt=(0,T.join)(O,"trash"),Bt=(0,T.join)(O,"backups"),Wt=(0,T.join)(O,"modes"),bs=(0,T.join)(O,"settings.json"),Ce=(0,T.join)(O,"claude-mem.db"),Vt=(0,T.join)(O,"vector-db"),Ne=(0,T.join)(O,"observer-sessions"),se=(0,T.basename)(Ne),hs=(0,T.join)(v,"settings.json"),Os=(0,T.join)(v,"commands"),Rs=(0,T.join)(v,"CLAUDE.md");function Ie(r){(0,y.mkdirSync)(r,{recursive:!0})}function Le(){return(0,T.join)(Pt,"..")}var D={dataDir:()=>O,workerPid:()=>(0,T.join)(O,"worker.pid"),serverBetaPid:()=>(0,T.join)(O,".server-beta.pid"),serverBetaPort:()=>(0,T.join)(O,".server-beta.port"),serverBetaRuntime:()=>(0,T.join)(O,".server-beta.runtime.json"),settings:()=>(0,T.join)(O,"settings.json"),database:()=>(0,T.join)(O,"claude-mem.db"),chroma:()=>(0,T.join)(O,"chroma"),combinedCerts:()=>(0,T.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(O,"transcript-watch-state.json"),corpora:()=>(0,T.join)(O,"corpora"),supervisorRegistry:()=>(0,T.join)(O,"supervisor.json"),envFile:()=>(0,T.join)(O,".env"),logsDir:()=>jt,archives:()=>Gt,trash:()=>Xt,backups:()=>Bt,modes:()=>Wt,vectorDb:()=>Vt,observerSessions:()=>Ne};var Ue=require("crypto");var De=require("os"),ye=x(require("path"),1);var X=require("fs"),j=x(require("path"),1),w={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Me(r){let e=j.default.join(r,".git"),t;try{t=(0,X.statSync)(e)}catch(u){return u instanceof Error&&u.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",u),w}if(!t.isFile())return w;let s;try{s=(0,X.readFileSync)(e,"utf-8").trim()}catch(u){return console.warn("[worktree] Failed to read .git file:",u instanceof Error?u.message:String(u)),w}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return w;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return w;let a=i[1],d=j.default.basename(r),m=j.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:m}}function ve(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,De.homedir)()):r}function qt(r){if(!r||r.trim()==="")return c.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=ve(r),t=ye.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return c.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return c.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function re(r){let e=qt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=ve(r),s=Me(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function B(r,e,t){return(0,Ue.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ne(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var C="claude";function Kt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function U(r){if(!r)return C;let e=Kt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:C}function xe(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Jt(r,e){return{customTitle:r,platformSource:e?U(e):void 0}}var W=class{db;constructor(e=Ce){e instanceof oe.Database?this.db=e:(e!==":memory:"&&Ie(O),this.db=new oe.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),s=this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid");if(!(e&&!s)){if(s)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),c.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){c.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>s.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),c.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),c.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,m=s==="relevance",u=m?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,g=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),E=[...e],S=[];if(o&&(S.push("project = ?"),E.push(o)),i)if(Array.isArray(i)){let f=i.map(()=>"?").join(",");S.push(`type IN (${f})`),E.push(...i)}else S.push("type = ?"),E.push(i);if(a){let f=Array.isArray(a)?a:[a],R=f.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");E.push(...f),S.push(`(${R.join(" OR ")})`)}if(d){let f=Array.isArray(d)?d:[d],R=f.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");f.forEach(M=>{E.push(`%${M}%`,`%${M}%`)}),S.push(`(${R.join(" OR ")})`)}let b=S.length>0?`WHERE id IN (${l}) AND ${S.join(" AND ")}`:`WHERE id IN (${l})`,A=this.db.prepare(`
      SELECT *
      FROM observations
      ${b}
      ${u}
      ${g}
    `).all(...E);if(!m)return A;let h=new Map(A.map(f=>[f.id,f]));return e.map(f=>h.get(f)).filter(f=>!!f)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Jt(n,o),m=d.platformSource??C,u=this.db.prepare(`
    ...
    `).get(e);if(u){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let l=u.platform_source?.trim()?U(u.platform_source):void 0;if(!l)this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),m=new Date(d).toISOString(),u=B(e,s.title,s.narrative),l=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,u,m,d,a||null,s.metadata??null);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let E=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,u);if(!E)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${u}`);return{id:E.id,createdAtEpoch:E.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),u=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let m=a??Date.now(),u=new Date(m).toISOString();return this.db.transaction(()=>{let l=[],E=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let A=B(e,p.title,p.narrative),h=E.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,p.agent_type??null,p.agent_id??null,A,u,m,d||null);if(h){l.push(h.id);continue}let f=S.get(e,A);if(!f)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${A}`);l.push(f.id)}let b=null;if(n){let A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,u,m);b=Number(A.lastInsertRowid)}return{observationIds:l,summaryId:b,createdAtEpoch:m}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,m,u){let g=m??Date.now(),l=new Date(g).toISOString();return this.db.transaction(()=>{let S=[],b=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),p=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let R of s){let M=B(e,R.title,R.narrative),be=b.get(e,t,R.type,R.title,R.subtitle,JSON.stringify(R.facts),R.narrative,JSON.stringify(R.concepts),JSON.stringify(R.files_read),JSON.stringify(R.files_modified),a||null,d,R.agent_type??null,R.agent_id??null,M,l,g,u||null);if(be){S.push(be.id);continue}let he=p.get(e,M);if(!he)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${M}`);S.push(he.id)}let A;if(n){let M=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,l,g);A=Number(M.lastInsertRowid)}if(this.db.prepare(`
        DELETE FROM pending_messages
        WHERE id = ? AND status = 'processing'
      `).run(o).changes!==1)throw new Error(`storeObservationsAndMarkComplete: failed to complete pending message ${o}`);return{observationIds:S,summaryId:A,createdAtEpoch:g}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),u=[...e],g=o?`WHERE id IN (${m}) AND project = ?`:`WHERE id IN (${m})`;o&&u.push(o);let E=this.db.prepare(`
      SELECT * FROM session_summaries
      ${g}
      ${a}
      ${d}
    `).all(...u);if(!i)return E;let S=new Map(E.map(b=>[b.id,b]));return e.map(b=>S.get(b)).filter(b=>!!b)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),u=[...e],g=o?"AND s.project = ?":"";o&&u.push(o);let E=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...u);if(!i)return E;let S=new Map(E.map(b=>[b.id,b]));return e.map(b=>S.get(b)).filter(b=>!!b)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,m;if(e!==null){let p=`
...
`}function gt(r,e,t,s){let n=[];return s?n.push(...rt(r)):n.push(...Xe(r)),s?n.push(...nt()):n.push(...Be()),s?n.push(...ot()):n.push(...We()),s?n.push(...it()):n.push(...Ve()),q(t)&&(s?n.push(...at(e,t)):n.push(...Ye(e,t))),n}var Ee=x(require("path"),1);function z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return c.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function ge(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Te(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function St(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Tt(r,e){return Ee.default.isAbsolute(r)?Ee.default.relative(e,r):r}function ft(r,e,t){let s=z(r);if(s.length>0)return Tt(s[0],e);if(t){let n=z(t);if(n.length>0)return Tt(n[0],e)}return"General"}function ns(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=St(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function bt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?z(r.facts).join(`
`):null}function os(r,e,t,s){let n=[];n.push(...qe(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=ge(a.displayTime);n.push(...ze(a,d))}else{let a=i.data,d=Te(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let l=bt(a,s);n.push(...Qe(a,u,l,s))}else n.push(Je(a,u,s))}return n}function is(r,e,t,s,n){let o=[];o.push(...dt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let m=d.data,u=ge(m.displayTime);o.push(...mt(m,u))}else{let m=d.data,u=ft(m.files_modified,n,m.files_read),g=Te(m.created_at),l=g!==a;a=g;let E=t.has(m.id);if(u!==i&&(o.push(..._t(u)),i=u),E){let S=bt(m,s);o.push(...ct(m,g,l,S,s))}else o.push(ut(m,g,l,s))}return o.push(""),o}function as(r,e,t,s,n,o){return o?is(r,e,t,s,n):os(r,e,t,s)}function ht(r,e,t,s,n){let o=[],i=ns(r);for(let[a,d]of i)o.push(...as(a,d,e,t,s,n));return o}function Ot(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Rt(r,e){let t=[];return e?(t.push(...H("Investigated",r.investigated,_.blue)),t.push(...H("Learned",r.learned,_.yellow)),t.push(...H("Completed",r.completed,_.green)),t.push(...H("Next Steps",r.next_steps,_.magenta))):(t.push(...P("Investigated",r.investigated)),t.push(...P("Learned",r.learned)),t.push(...P("Completed",r.completed)),t.push(...P("Next Steps",r.next_steps))),t}function At(r,e){return e?lt(r):Ze(r)}function Ct(r,e,t){return!q(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?pt(r.totalDiscoveryTokens,r.totalReadTokens):et(r.totalDiscoveryTokens,r.totalReadTokens)}function Nt(r){return{id:r.id,contentSessionId:r.content_session_id,project:r.project,status:r.status,trigger:r.trigger,stateSection:r.state_section,arcSection:r.arc_section,nextSection:r.next_section,transcriptFill:r.transcript_fill,generatedAtEpoch:r.generated_at_epoch,approvedAtEpoch:r.approved_at_epoch}}function Se(r,e,t="approved"){let s=t==="any"?"":`AND status = '${t}'`,n=r.prepare(`
    SELECT * FROM continuity_summaries
    WHERE project = ? ${s}
    ORDER BY generated_at_epoch DESC
    LIMIT 1
  `).get(e);return n?Nt(n):null}var Dt=require("bun:sqlite");var ds=It.default.join((0,Lt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function _s(){try{return new W}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Mt.unlinkSync)(ds)}catch(e){e instanceof Error?c.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):c.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return c.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function us(r,e){return e?Et(r):tt(r)}function cs(r){let t=[`## ${r.status==="draft"?"[automated draft \u2014 pending review] ":""}Continuity Summary`];return r.stateSection&&t.push(`
### STATE
${r.stateSection}`),r.arcSection&&t.push(`
### ARC
${r.arcSection}`),r.nextSection&&t.push(`
### NEXT
${r.nextSection}`),t.join(`
`)}function ms(r,e,t,s,n,o,i){let a=[],d=ue(e);a.push(...gt(r,d,s,i));let m=t.slice(0,s.sessionCount),u=He(m,t),g=pe(e,u),l=Ge(e,s.fullObservationCount);a.push(...ht(g,l,s,n,i));let E=t[0],S=e[0];Ot(s,E,S)&&a.push(...Rt(E,i));let b=le(e,s,o,n);return a.push(...At(b,i)),a.push(...Ct(d,s,i)),a.join(`
`).trimEnd()}async function fe(r,e=!1){let t=ae(),s=r?.cwd??process.cwd(),n=re(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=_s();if(!a)return"";try{let d=o.length>1?$e(a,o,t):ce(a,i,t),m=o.length>1?Pe(a,o,t):me(a,i,t),u="";try{let l=new Dt.Database(D.database(),{readonly:!0});try{let E=Se(l,i,"approved")??Se(l,i,"draft");u=E?cs(E):""}finally{l.close()}}catch{}if(d.length===0&&m.length===0){let l=us(i,e);return u?`${u}

${l}`:l}let g=ms(i,d,m,t,s,r?.session_id,e);return u?`${u}

${g}`:g}finally{a.close()}}0&&(module.exports={generateContext});
